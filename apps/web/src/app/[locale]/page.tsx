...
const SearchBar = dynamic(() => import('@/components/design-system/SearchBar').then(mod => ({ default: mod.SearchBar })), { 
  ssr: false,
  loading: () => <div className="max-w-2xl mx-auto mb-8 animate-slide-up" style={{ animationDelay: '0.2s' }}>
    <div className="relative">
      ...
      <input
        type="text"
        placeholder="Поиск скидок, брендов, категорий..."
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-brand-500 via-brand-600 to-brand-700 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-30">
          <SplineViewer 
            url="https://prod.spline.design/8C1b0G3-51iDy5hm/scene.splinecode"
            style={{
              width: '100%',
              height: '100%',
            }}
